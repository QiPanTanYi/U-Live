...
public enum ResponseStatusEnum {
    ...
    USER_INFO_UPDATED_ULIVENUM_EXIST_ERROR(5092,false,"游Live号已经存在！"),
    USER_INFO_CANT_UPDATED_ULIVENUM_ERROR(5092,false,"游Live号无法修改！"),
    ...
    // 密码登录错误代码
    MOBILE_OR_PASSWORD_NULL(600, false, "手机号或密码输入为空！"),
    MOBILE_NOT_EXIST_ERROR(601, false, "用户不存在！"),
    PASSWORD_ERROR(602, false, "密码输入错误！"),
